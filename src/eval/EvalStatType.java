...
//	/sensitivity_5fold_ressult\\
	...
	public static void main(String[] args) {
		...
		String fop_output=PathConstanct.PATH_PROJECT_TTT_CUR_EVAL_DATA+File.separator+"evalStatType"+File.separator;
...
//		System.out.println(mapTotalId.size()+" Map total ID loaded!");
		ReorderingTokens.reorderingTokensOnlyForStatType(fop_input+fn_testSource,fop_input+fn_testTarget, fop_input+fn_testTranslation, fop_input+fn_correctOrderTranslated);
