...
class SignatureAnnotationType{
	public static String Invocation="#invocation";
	
}

public class SignatureInferenceVisitor  extends ASTVisitor {
	 ...
	 */
	public SignatureInferenceVisitor(String fop_jdk,String fop_project,boolean isParsingType) {
...
//		node.getName().accept(this);
		if(isParsingType){
			this.buffer.append(node.getName().getIdentifier()+SignatureAnnotationType.Invocation);
		}else{
			this.buffer.append("MethodSig-123");
		}
