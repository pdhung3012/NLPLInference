...
public class GenerateStatMethodIdenTenFolds {
	...
	public void extractGoodPercentage(ArrayList<Integer> listNumbers,String[] listLocations,String[] listSources){
	...
	public void filterGoodPercentage(ArrayList<Integer> listNumbers,ArrayList<String> listLocations){
