...
public class AliasPaCorpusToIntForStattype {
	...
	public static void main(String[] args) {
		String folderInput=PathConstanct.PATH_PROJECT_STATTYPE_DATA;
		String folderNormalize=PathConstanct.PATH_PROJECT_STATTYPE_ALIAS;
